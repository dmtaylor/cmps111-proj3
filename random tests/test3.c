/*	This test is meant to:
	Show that after allocating and deallocating memory, trying to deallocate an already 
	freed region is immediately detected.
	This test should exit with an error that an unallocated region was passed to free and then print statistics.
*/
